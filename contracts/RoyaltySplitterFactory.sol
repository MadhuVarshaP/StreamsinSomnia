...
contract RoyaltySplitterFactory {
    ...
    function createSplitter(RoyaltySplitter.Share[] calldata shares) external payable returns (address splitter) {
        ...
        splitter = address(new RoyaltySplitter{value: msg.value}(shares));
